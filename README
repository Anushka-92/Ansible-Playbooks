...
![Screenshot of Feature](C:\Users\Anurag\Desktop\MyPlaybook/1.png)
![Screenshot of Feature](C:\Users\Anurag\Desktop\MyPlaybook/2.png)
After executing command of visudo below window will be opened , add user list like below--
![Screenshot of Feature](C:\Users\Anurag\Desktop\MyPlaybook/3.png)
To establish SSH connectionamong all 3 instnaces, follow command-- vi /etc/ssh/sshd_config
![Screenshot of Feature](C:\Users\Anurag\Desktop\MyPlaybook/4.png)
Reload the changes made in sshd_config file by command --service sshd reload
